    ...
    <>
      <Box p="25px" bg={"rgb(65, 42, 76)"}>
        ...
        <Box padding={"25px"} ml="93px" color="white">
          <Text mb="30px" fontSize={"40px"} textAlign={"start"}>
            Sign up form{" "}
            <Text color="#E57CD8" as="em">
              Free
            </Text>{" "}
            Toogle Track account
          </Text>
          <Text
            lineHeight={"2rem"}
            fontSize={"22px"}
          ...
          <Text textAlign={"start"} fontSize={"22px"}>
            Already have an account?{" "}
            <Text fontSize={"22px"} as="u" color="#E57CD8">
              Log in here.
            </Text>
          </Text>
        </Box>
        ...
        <Flex p="40px">
          ...
          >
            <Flex justifyContent={"space-around"}>
              ...
              >
                {" "}
                <Box>
                  <AiFillApple size={"30px"} color="black" p="0px 5px" />
                </Box>{" "}
                Login via Apple
              </Button>
            </Flex>
            ...
            <Box mt={"50px"} padding={"20px"}>
              ...
              <Box mb="30px" cursor={"pointer"} textAlign={"end"}>
                Forget Password?
              </Box>

              <Button
                onClick={handleSignup}
                _hover={{ bg: "rgb(65, 42, 76)" }}
                p="25px 40px"
                borderRadius={"30px"}
                w="100%"
                margin="auto"
          ...
          <Box pt="40px" w="40%" color="white">
            <Text textAlign={"justify"} fontSize={"5xl"}>
              "
            </Text>
            <Text
              mb="30px"
              ...
              fontSize={"2xl"}
            >
              Toggle Track has a very straightforward interface. It's easy to
            ...
            <Text width={"80%"} textAlign={"justify"} fontSize={"2xl"}>
              <Text color="rgb(255, 222, 145)" as="em">
                It just works,
              </Text>{" "}
              even in a team where some members find new interfaces challenging.
            </Text>
            <Text
              mt="20px"
              mb="25px"
